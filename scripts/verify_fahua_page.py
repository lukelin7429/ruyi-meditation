#!/usr/bin/env python3
"""Verify a fahua-wenju page against the CBETA base text (T1718).

Usage: python3 verify_fahua_page.py <page.html> <start_line> <end_line>
...
BASE = "/Users/hayashikisshou/Library/Mobile Documents/iCloud~md~obsidian/Documents/第二個大腦/知識庫/佛法/大正藏/16_經疏部/T1718_妙法蓮華經文句.md"
